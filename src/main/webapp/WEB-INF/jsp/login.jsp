...
<script type="text/javascript" src="js/login/placeholder.js" src="js/md5.js"></script>
		...
		$("#login")
				.click(
						function() {
                            ...
                            pwd.value =  hex_md5(password_input.value);
									...
									$
											.ajax({
												...
												console.log("account_erroe.");
														...
														rcode_flag = 1;
														$("#randiv").show();
													}else if (data.msg == 'login_fail_recount_error') {
                                                        $("#errorspan")
                                                            .html(
                                                                "<font color='red'> 登录失败多次，账户锁定10分钟！</font>");
                                                        rcode_flag = 1;
                                                        $("#randiv").show();
                                                    }else {
